...
class MacroDetailScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final cals = singleFood != null
        ? singleFood!.calories
        : (totals['calories'] ?? 0);
    final pro = singleFood != null
        ? singleFood!.protein
        : (totals['protein'] ?? 0);
    final carbs = singleFood != null
        ? singleFood!.carbs
        : (totals['carbs'] ?? 0);
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      singleFood?.name ?? 'Today\'s Nutrition',
...
class _CaloriePieRow extends StatelessWidget {
  ...
  const _CaloriePieRow({
    required this.proteinCals,
    required this.carbsCals,
    required this.fatsCals,
